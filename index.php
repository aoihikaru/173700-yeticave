        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$lots[$key]['pic_url'] ?>" width="350" height="260" alt="<?=$lots[$key]['name'] ?>">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=$lots[$key]['category'] ?></span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$lots[$key]['name'] ?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?=$lots[$key]['price'] ?><b class="rub">р</b></span>
                        </div>
